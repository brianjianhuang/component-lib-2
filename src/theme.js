...
export const colors = Object.assign({}, flattened, {
  black: '#000',
  white: '#fff',
  primarybackGround: flattened.gray0,
  primary: flattened.blue5,
  secondary: flattened.blue2,
  accent: flattened.green1,
  warning: flattened.yellow3,
  alert: flattened.red5,
  default: flattened.gray3
})
